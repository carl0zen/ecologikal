...
$lastmemberid = $_GET['last_member_id'];
?>
<?php $members = get_next_members($lastmemberid);
		...
		<div class="member" id = "<?php echo $members[$key]['user_id']; ?>" >
			...
			<div class="buttons">
				...
				<a href="<?php echo _VIEWS_URL_ ?>members/sendmessage.php?user_id=<?php echo $userid ?>" class="iframe sendmessage" class="iframe sendmessage"></a>
			</div><!--Buttons-->
		</div>	<!--member-->
<?php	}//End if
	} // End Foreach?>