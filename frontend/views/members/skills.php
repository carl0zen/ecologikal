...
<div class="petalslist clearfix">
	...
	<div id="skillslist" class="clearfix">
		<?php if($myprofile){?>

				<a href="#" class="button addskill tiptip" id="addskill_btn" title="Add Skill" ><div class="ecoicon plus"></div></a>
	...
	<flower>
		...
		for($x=1;$x<8;$x++){
			...
			<div id="p<?php echo $x?>" class="<?php echo $petalclass ?> relative dpetal" >
      	<a href="#" class="closepetal"></a>
				<petalicon></petalicon>
				<span id="petalName"><?php echo $petalname ?></span>
				<span id="noSkills"><?php echo $noskills?> skills</span>
				<span id="percSkills"><?=($petalgrade > 0) ? $petalgrade.'%' : '';?> </span>
...
<script>
	$(document).ready(function(e){
		...
		appended = false;
		$('.addskill').live('click',function(e){
		if (appended == false){
		...
		$('.closepetal').click(function(){ $('.dpetal').slideUp(200); return false;});
	});
</script>