...
<?php
	...
	<div id="iframe">
			...
			<h2><span class="iconic home"></span> <?php echo members_get_album_name($userid, $picture['album_id'])?><span class="picno"><?php echo 	members_albums_get_pic_no($picid, $userid, $picture['album_id']); ?> of <?php echo members_count_album_pictures($picture['album_id']) ?></span></h2>

			<div class="imagecontainer">
				<?php if($prevpic){ ?>
					<div class="prev" onclick = "location.href='?type=member&picid=<?php echo $prevpic ?>&user_id=<?php echo $userid?>'" >
				...
				<?php if($nextpic){ ?>
					<div class="next" onclick = "location.href='?type=member&picid=<?php echo $nextpic ?>&user_id=<?php echo $userid?>'" >
...
$(document).ready(function(e){
	...
	$('.deletecomment').live('click',function(e){
		...
		alert(comment_id);
		queryurl = BACKEND_URL + 'members/deletepicturecomment.php';
