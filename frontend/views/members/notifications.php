<?php
	...
	<content>
		<h1><?php echo members_get_info('nombre', $userid)?>'s Notifications<button class="green deleteall">Delete All</button></h1>
		<?php $notifications = members_get_notifications($userid);
