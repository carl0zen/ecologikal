...
<div id="profilecontent" class="clearfix">
	<fields <? if ($edit == 1){ echo "class='editmode'"; } ?>>
  	<? if( $myprofile && $edit != 1 ) : ?>
		<div class="margin10b"><button class="green iconspan edit" onclick="location.href='?edit=1'"><span class="ui-icon ui-icon-unlocked"></span>Edit</button></div>
		<? endif; ?>
		<h3>Basic Information</h3>

		<div id="about"><strong>About: </strong><span <?php if($myprofile && $edit==1){echo "class='editable aboutme tiptip' title='Click to Edit About Me'";}?>><?php echo members_get_info("aboutme",$userid)?></span></div>

		<div id = "email"		 ><strong>Email: </strong><span <?php if($myprofile && $edit==1){echo "class='editable email tiptip' title='Click to Edit Email'";}?>><?php echo members_get_info("email",$userid)?></span></div>

		<div id = "telephone"	 ><strong>Phone: </strong><span <?php if($myprofile && $edit==1){echo "class='editable phone tiptip' title='(Country Code) + Telephone'";}?>><?php echo members_get_info("phone",$userid)?></span></div>

		<div id = "sex"			 ><strong>Gender: </strong><span <?php if($myprofile && $edit==1){echo "class='editable genderselect tiptip' title='Click to Edit Gender'";}?>><?php echo members_get_info("gender",$userid)?>	</span></div>

		<div id = "dob"			 ><strong>Birthday: </strong><span <?php if($myprofile && $edit==1){echo "class='editable dobselect tiptip' title='Click to Edit Date of Birth'";}?>><?php echo members_get_info("dob",$userid)?></span></div>

		<div id = "country"	 ><!--<div class="icon flag"><?php display_country_flag(members_get_info("country",$userid));?></div>--><strong>Country: </strong><span <?php if($myprofile && $edit==1){echo "class='editable country tiptip' title='Click to Edit Country'";}?>><?php echo members_get_info("country",$userid)?></span></div>
