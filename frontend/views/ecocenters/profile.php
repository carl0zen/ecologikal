...
<div class="wrapper" id="ecocenter">
  <div id="content" class="clearfix">
    ...
    <div id="skills" class="relative fleft clearfix"><div class="padding10l">
      ...
      <div id="bookingform" class="margin10b">
        <h2 class="line40"><div class="icon bookingicon"></div>Travel Here</h2>
        <input type="text" name="date" value="" id="date">
        <input type="text" name="nodays" value="" id="nodays">
        <h2 class="margin10b">Search for</h2>
        <button class="green accomodation margin5b">Rooms</button>
        <button class="green workshops margin5b">Workshops</button>
        <button class="green volunteer">Vacancies</button>
      </div>

      <div id="reputation">
        <div class="clearfix"><div class="icon vibe fleft"></div><h2 class="fleft line20">Place Vibe</h2></div>
        <div id="bargraph"></div>
    ...
    <div id="maincontent" class="fright clearfix">
      ...
      <div id="tabs" class="clearfix width100">
        <ul>
          ...
          <li><a title= "services" href="tabs/gallery.php?ec_id=<?php echo $ec_id ?>">Gallery</a></li>
...
<script>
	...
	$(document).ready(function(e){
		...
		$('#bargraph').jqbargraph({ data: arrayOfData, width:'225px', height: '100px', barSpace: 5, speed:1, showValues: false, postfix: '%' });
