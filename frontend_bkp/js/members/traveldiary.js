$(document).ready(function(e){
	...
	// Adds a new stop
		$('button.addstop').click(function(e){
			$(this).fadeOut(0);
			$('#stops').append('<input id="address" type="text">');
	...
	$('span.deletetrip').click(function(e){
		...
		question = confirm('Are you really Sure you want to delete this trip?');
		if(question){
	...
	$('span.deletestop').click(function(e){
		tripid = $('#tripid').val();
		stopid = $(this).parent().parent().parent().find('#stopid').val();
