<?php
	...
	// If a parameter is passed with the user_id then it displays the profile for the user_id passed, if not it means that should display loggedin
			...
			$('#address').autocomplete({
			            ...
			            cb:{
			              ...
			              select: function(item) {
							...
							$('#tripdesc').watermark('Describe your trip').keyup(function(e){
								limitText(this,240);
							}).charCount({
								allowed: 240,
								warning: 40,
...
<div id="profilecontent" class="trips clearfix">
	<h3>Travel Diary
		<?php if($myprofile){?>
