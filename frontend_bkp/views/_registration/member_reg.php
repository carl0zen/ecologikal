...
<div id="forma_registro" >
	...
	<fieldset>
		...
		<input name="miembro_forma_registro_usuario" type="text" class="text ui-widget-content ui-corner-all tiptip" title="Username" id="miembro_forma_registro_usuario" title="Username"/>
	...
	<a href='<?php echo _VIEWS_URL_ ?>members/member_profile.php' class="iframe selectaccount"></a>
	</form>
</div>
<?php } //ELSE END ?>