...
<div id="iframe">
	...
	<h1>Add Settlers</h1>
	<div class="form">
		<input type="text" name="addsettlers" value="" id="addsettlers">

		<button class="green savesettlers">Save Settlers</button>
		<?php }else{
...
<script>
	$(document).ready(function(e){
		...
		$('#addsettlers').autoSuggest(queryurl,{
		...
		$('button.savesettlers').click(function(e){
						ec_id		 	= <?php echo $ec_id ?>;
						friends = $('#as-values-friends').val();


						queryurl = BACKEND_URL + 'ecocenters/people/savesettlers.php';
